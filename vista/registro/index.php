                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow align-items-center justify-content-between mb-4">
                        <div class="card-body" style="width: 50%;">
                            <form class="user" action="<?php echo constant('URL') ?>registroControl/registrog" method="post" id="datosRegistro">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="ciudad" name="ciudad"
                                            placeholder="Ciudad origen" value="CUCUTA" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                    </div>
                                    <div class="col-sm-6">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Corporacion Recreativa Tennis Golf 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
